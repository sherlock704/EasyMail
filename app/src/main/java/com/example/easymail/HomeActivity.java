                ...
                send.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        if(TextUtils.isEmpty(to.getText().toString())){
                            ...
                            Toast.makeText(HomeActivity.this,"Please enter TO",Toast.LENGTH_LONG).show();
                            return;
                        }
                        else if(TextUtils.isEmpty(cc.getText().toString())){
                            Toast.makeText(HomeActivity.this,"Please enter CC",Toast.LENGTH_LONG).show();
                            return;
                        }
                        else if(TextUtils.isEmpty(subject.getText().toString())){
                            Toast.makeText(HomeActivity.this,"Please enter subject",Toast.LENGTH_LONG).show();
                            return;
                        }
                        else if(TextUtils.isEmpty(mailbody.getText().toString())){
                            Toast.makeText(HomeActivity.this,"Please enter mailbody",Toast.LENGTH_LONG).show();
                            return;
                        }
                        else if(TextUtils.isEmpty(shedule)){
                            Toast.makeText(HomeActivity.this,"Please enter shedule",Toast.LENGTH_LONG).show();
                            return;
                        }
